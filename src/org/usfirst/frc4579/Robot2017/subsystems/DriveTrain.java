...
public class DriveTrain extends PIDSubsystem {
    ...
    public void continuousTurn(String dir) { // USE THIS ONLY TEMPORARILY, AT LEAST UNLESS 
    	double negator = 1;
    	if (dir == "left") {
    		negator = -1;
    	}
    ...
    public double returnPIDInput() {
    	double angle = Robot.meas.getAngle() % 360; //Since setContinuous treats the beginning and end as the same, there isn't a problem with 359/1.
    	return angle;
    }
    public double usePIDOutput(double output) {
