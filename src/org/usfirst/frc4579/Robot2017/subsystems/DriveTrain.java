...
public class DriveTrain extends PIDSubsystem {
    ...
    //Enable the PID controller with a specified angle. Overloaded method. Not sure I need this method though.
    ...
    public double returnPIDInput() {
    	double angle = 90.0; //Robot.meas.getAngle() % 360; //Since setContinuous treats the beginning and end as the same, there isn't a problem with 359/1.
    	return angle;
    }
