...
public class OI {
    ...
    public JoystickButton startThing;
    public Joystick joysticky;
    ...
    public OI() {
        ...
        startThing = new JoystickButton(joysticky, 1);
        startThing.whenPressed(new AlignToShip());


        // SmartDashboard Buttons
        SmartDashboard.putData("Autonomous Command", new AutonomousCommand());
        SmartDashboard.putData("Default Drive", new DefaultDrive());
        SmartDashboard.putData("AlignToShip", new AlignToShip());
