...
public class OI {
    ...
    public OI() {
        ...
        gateButton = new JoystickButton(joystick, 2);
        gateButton.whileHeld(new moveGates());
        ...
        SmartDashboard.putData("RotateAngle", new RotateAngle());
        SmartDashboard.putData("moveGates", new moveGates());
        SmartDashboard.putData("rotatePusher", new rotatePusher());

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        climbButton = new JoystickButton(joystick,3);
        climbButton.whileHeld(new Climb());
        descendButton = new JoystickButton(joystick,2);
        descendButton.whileHeld(new Descend());
    }
