...
public class RobotMap {
    ...
    public static void init() {
        ...
        driveTraincontrollerLeft = new Talon(0);
        LiveWindow.addActuator("DriveTrain", "controllerLeft", (Talon) driveTraincontrollerLeft);
        
        driveTraincontrollerRight = new Talon(1);
        LiveWindow.addActuator("DriveTrain", "controllerRight", (Talon) driveTraincontrollerRight);
