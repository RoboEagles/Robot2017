...
public class RobotMap {
    ...
    public static Servo servoTestSystemTinyServo;
    public static Servo servoTestSystemleftServo;
    public static Servo servoTestSystemrightServo;
...
/*        driveTrainRobotDrive = new RobotDrive(driveTraincontrollerLeft, driveTraincontrollerRight);
        ...
        servoTestSystemTinyServo = new Servo(5);
        LiveWindow.addActuator("ServoTestSystem", "TinyServo", servoTestSystemTinyServo);
        
        servoTestSystemleftServo = new Servo(6);
        LiveWindow.addActuator("ServoTestSystem", "leftServo", servoTestSystemleftServo);
        
        servoTestSystemrightServo = new Servo(7);
        LiveWindow.addActuator("ServoTestSystem", "rightServo", servoTestSystemrightServo);
