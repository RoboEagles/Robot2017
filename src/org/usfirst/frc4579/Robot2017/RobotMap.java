...
public class RobotMap {
    ...
    public static Ultrasonic ultraSonicDistance;
    ...
    public static void init() {
        ...
        ultraSonicDistance = new Ultrasonic(0, 1);
        LiveWindow.addSensor("UltraSonic", "Distance", ultraSonicDistance);
        

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        
        //ultraSonicLeft.setOversampleBits(4);
        //ultraSonicLeft.setAverageBits(4);
        //ultraSonicLeft.setAccumulatorInitialValue(0);
        //ultraSonicLeft.setAccumulatorCenter(2048);
        //ultraSonicLeft.setAccumulatorDeadband(10);
        //ultraSonicLeft.resetAccumulator();
        
       // ultraSonicRight.setOversampleBits(4);
       // ultraSonicRight.setAverageBits(2);
      //  ultraSonicRight.setAccumulatorInitialValue(0);
      //  ultraSonicRight.setAccumulatorCenter(2048);
      //  ultraSonicRight.setAccumulatorDeadband(10);
      //  ultraSonicRight.resetAccumulator();
