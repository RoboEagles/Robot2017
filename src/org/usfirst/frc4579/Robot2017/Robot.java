...
public class Robot extends IterativeRobot {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS 
        dashcam = new CameraServer.getInstance().startAutomaticCapture();
        
        new Thread(() -> {
        	//The thread isn't really necessary in this case, it's only when we add loops that it becomes necessary.
            dashcam.setResolution(320,240);
            dashcam.setFPS(10); // the FPS should be set to 10 when processing things only
        }
