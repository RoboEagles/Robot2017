...
public class GRIPCastleTowerGoalPipeline {
	...
	public void process() {
		...
		double[] hsvThresholdSaturation = {0.0, 33.0716723549488};
		...
		double[] filterContoursSolidity = {37.76978417266187, 55.63139931740615};
	...
	private void filterContours(List<MatOfPoint> inputContours, double minArea,
		...
		for (int i = 0; i < inputContours.size(); i++) {
			...
			double numRows = contour.rows();
			if (numRows < minVertexCount || numRows > maxVertexCount) continue;
