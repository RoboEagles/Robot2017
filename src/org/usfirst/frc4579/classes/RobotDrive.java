...
package org.usfirst.frc4579.classes;
...
public class RobotDrive implements MotorSafety {
  ...
  public void arcadeDrive(double moveValue, double rotateValue, boolean squaredInputs) {
    ...
    double rightMotorScaleFactor = 0.89; //limit(SmartDashboard.getNumber("RIGHT MOTOR SCALE FACTOR", 0.0));
    setLeftRightMotorOutputs(leftMotorSpeed, rightMotorSpeed*rightMotorScaleFactor);
  }
